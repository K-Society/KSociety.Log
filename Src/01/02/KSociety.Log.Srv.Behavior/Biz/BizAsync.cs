...
public class BizAsync : IBizAsync
{
    ...
    public async ValueTask<WriteLog> WriteLogAsync(KSociety.Log.App.Dto.Req.Biz.WriteLog request, CallContext context = default)
    {
    ...
    public async ValueTask<WriteLog> WriteLogsAsync(KSociety.Log.App.Dto.Req.Biz.List.WriteLog request, CallContext context = default)
    {
        return await _commandHandlerAsync
