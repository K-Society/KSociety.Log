...
namespace KSociety.Log.Serilog.Sinks.RabbitMq
{
    ...
    public static class LoggerConfigurationRabbitMqExtension
    {
        ...
        public static LoggerConfiguration RabbitMq(
            this LoggerSinkConfiguration loggerConfiguration,
            string mqHostName, string mqUserName, string mqPassword, string brokerName,
            Base.EventBus.ExchangeType exchangeType,
        ...
        )
        {
            ...
            IExchangeDeclareParameters exchangeDeclareParameters =
                new ExchangeDeclareParameters(brokerName, exchangeType, exchangeDurable, exchangeAutoDelete);
